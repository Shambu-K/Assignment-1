...
\end{align}
Here, \newline k=no. of sixes in six throws of a dice
\newline n=no. of throws i.e. 6
\newline p=probablility of getting a six in a single throw of dice = \( \frac{1}{6} \) 
\newline 1-p=\( \frac{5}{6} \)
...
\newline $$ P(X=2)={6 \choose 2} \times( \frac{1}{6})^{2} \times  (\frac{5}{6}) ^{6-2}$$ 
\newline $$P(X\leq 2) = \( \frac{5^6}{6^6} \) \times 1 + \( \frac{5^5}{6^6} \) \times 6 + \( \frac{5^4}{6^6} \) \times 15$$ 
