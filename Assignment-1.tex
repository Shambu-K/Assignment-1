...
\newcommand\Mymacrocomb[2][^n]{\prescript{#1\mkern-0.5mu}{}C_{#2}}
...
\begin{align}
P(X=k) = \Mymacrocomb[n]{k}  p^{k} (1-p)^{n-k}
\end{align}
Here,
\begin{table}[H]
\centering
...
\pr{X\leq 2}&=\pr{X=0}+\pr{X=1}+\pr{X=2}\\
 \pr{X=0}&=\Mymacrocomb[6]{0} \times \brak{\frac{1}{6}}^{0} \times  \brak{\frac{5}{6}} ^{6-0}\\
\pr{X=1}&=\Mymacrocomb[6]{1} \times \brak{\frac{1}{6}}^{1} \times  \brak{\frac{5}{6}} ^{6-1}\\
 \pr{X=2}&=\Mymacrocomb[6]{2} \times \brak{\frac{1}{6}}^{2} \times  \brak{\frac{5}{6}} ^{6-2}\\
