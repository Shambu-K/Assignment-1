...
\begin{center}
 ...
 \hline
 n & no. of throws i.e. 6  \\ 
 \hline
 p & probablility of getting a six in a single throw of dice = \( \frac{1}{6} \)\\ [1ex]
 \hline
...
\newline 
\begin{equation}
P(X\leq 2) = \( \frac{5^6}{6^6} \) \times 1 + \( \frac{5^5}{6^6} \) \times 6 + \( \frac{5^4}{6^6} \) \times 15
\end{equation}
